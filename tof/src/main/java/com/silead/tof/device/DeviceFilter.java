...
public final class DeviceFilter {
    ...
    public DeviceFilter(final int vid, final int pid, final int clazz, final int subclass,
                        final int protocol, final String manufacturer, final String product, final String serialNum) {
        this(vid, pid, clazz, subclass, protocol, manufacturer, product, serialNum, false);
    }
    ...
    /**
     * Get device filter from xml file
     *
     * @param context
    ...
    /**
     * 返回指定的类子类协议是否与此设备筛选器匹配
     * mExclude 标志应单独检查 @isExclude 或自行检查
     *
     * @param clazz
     * @param subclass
     * @param protocol
...
/*		if (mManufacturerName != null && device.getManufacturerName() == null)
    ...
    /**
     * 匹配此设备筛选器并返回 true，如果 mExclude 为 true
     *
     * @param device
     * @return
     */
