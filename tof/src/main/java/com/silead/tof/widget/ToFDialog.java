...
import com.silead.tof.R;
import com.silead.tof.device.DeviceFilter;
import com.silead.tof.device.USBMonitor;

import java.util.ArrayList;
import java.util.List;

public class ToFDialog extends DialogFragment {
    private static final String TAG = "ToFDialog";
     ...
     * @return
     */
    public static ToFDialog showDialog(final Activity parent/* add parameters here if you need */) {
        ToFDialog dialog = newInstance(/* add parameters here if you need */);
        try {
    ...
    public static ToFDialog newInstance(/* add parameters here if you need */) {
        final ToFDialog dialog = new ToFDialog();
    ...
    public void onAttach(final Activity activity) {
        ...
        if (mUSBMonitor == null)
            try {
                mUSBMonitor = ((ToFDialogParent)activity).getUSBMonitor();
            ...
            switch (which) {
                case DialogInterface.BUTTON_POSITIVE:
                    ...
                    if (item instanceof UsbDevice) {
                        ...
                        ((ToFDialogParent) getActivity()).onDialogResult(false);
                    }
                    break;
                case DialogInterface.BUTTON_NEGATIVE:
                    ((ToFDialogParent) getActivity()).onDialogResult(true);
                    break;
            }
        }
    };
